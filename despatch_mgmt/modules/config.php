...
/* ── R2 fallback stubs — only defined if r2_helper.php not yet loaded ── */
...
/* ── canViewAll: check if user can see all users' transactions for a module ── */
function canViewAll(string $module): bool {
